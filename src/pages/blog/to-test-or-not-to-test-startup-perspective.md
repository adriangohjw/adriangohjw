...
## Importance of tests {/*importance-of-tests*/}
...
## But almost always, speed is more important {/*but-almost-always-speed-is-more-important*/}
...
## Why bother writing tests then {/*why-bother-writing-tests-then*/}
...
> <i>... as the company has grown to such mammoth proportions that spending time fixing bugs was slowing it down faster than its risky attitude toward development.</i>

## So when do we write tests {/*so-when-do-we-write-tests*/}
...
### Too many cases to test manually {/*too-many-cases-to-test-manually*/}
